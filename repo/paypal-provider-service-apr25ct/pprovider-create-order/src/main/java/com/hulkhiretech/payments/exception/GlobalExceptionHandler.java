...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handlePaypalException(
        ...
        return new ResponseEntity<>(errorResponse, 
        		ex.getHttpStatus()); // Or custom status
    }
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(Exception ex) {
    	...
    	log.error("Returning Generic Error Exception: {}",ex.getMessage(), ex);
        
        return new ResponseEntity<>(errorResponse, HttpStatus.INTERNAL_SERVER_ERROR); // Or custom status
    }
