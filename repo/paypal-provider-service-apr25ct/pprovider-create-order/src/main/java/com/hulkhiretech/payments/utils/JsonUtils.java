...
/**
 * uses Jackson to convertJava objects to JSON and vice versa.
 */
@Component
...
public class JsonUtils {
	...
	/*
	 * convert a json string to java object of the specified class,
	 * 
	 * @param json the JSON string to object
